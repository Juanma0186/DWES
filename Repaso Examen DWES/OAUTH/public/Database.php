...
class Database
{
    private static $instance; // Variable estática para almacenar la única instancia de la clase
    private $config;
    private $conect;
    // Definir constante para la ruta del archivo de configuración JSON
    private const CONFIG_FILE = 'bd.json';
